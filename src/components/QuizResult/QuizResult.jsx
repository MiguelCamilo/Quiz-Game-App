		...
		<div className="mt-20">
			...
			<div className="bg-white h-[38rem] w-[23rem] md:h-[40rem] md:w-[35rem] rounded-xl">
				...
				<button onClick={handle_reset} className="text-center">
					<div className="ml-[6.5rem] mt-[5rem] sm:ml-[10rem] sm:mt-[10rem] w-[80%] sm:w-[100%] p-5 border-2 border-[#6066D0B2] rounded-xl hover:bg-[#F9A826] hover:border-[#F9A826] hover:text-white text-[#6066D0B2] font-bold">
						Try Again
					</div>
				</button>
			</div>
